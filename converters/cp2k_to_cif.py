...
if __name__ == "__main__":
    ...
    coord_mode = parser.add_mutually_exclusive_group()
    coord_mode.add_argument('--scaled', action='store_true',
                            help='Treat coordinates as fractional (SCALED T)')
    coord_mode.add_argument('--no-scale', action='store_true',
    ...
    use_scaled = args.scaled or (file_scaled and not args.no_scale)
